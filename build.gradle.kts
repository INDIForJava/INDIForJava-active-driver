    ...
    publications {
        create<MavenPublication>("maven") {
            ...
            pom {
                ...
                url.set("https://github.com/INDIForJava/INDIForJava-active-driver")
                licenses {
                    license {
                ...
                scm {
                    connection.set("scm:git:git://github.com/INDIForJava/INDIForJava-active-driver.git")
                    developerConnection.set("scm:git:ssh://github.com/INDIForJava/INDIForJava-active-driver.git")
                    url.set("https://github.com/INDIForJava/INDIForJava-active-driver")
                }
            }
        }
